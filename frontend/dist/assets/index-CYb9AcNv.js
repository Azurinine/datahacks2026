...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new K(0,1,0);return new hi({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new hi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new hi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
	...
	`}var to=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Xr([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},$c=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},el=new Zi(-1,1,1,-1,0,1),tl=new class extends or{constructor(){super(),this.setAttribute(`position`,new Jn([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Jn([0,2,0,0,2,0],2))}},nl=class{constructor(e){this._mesh=new kr(tl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,el)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},rl=class extends $c{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof hi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=fi.clone(e.uniforms),this.material=new hi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new nl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},il=class extends $c{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},al=class extends $c{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},ol=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Et(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new rl(Qc),this.copyPass.material.blending=0,this.timer=new ra}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}il!==void 0&&(r instanceof il?n=!0:r instanceof al&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},sl=class extends $c{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new X}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}};function cl(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new or,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=ll(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=ll(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function ll(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new Gn(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}function ul(e,t){let n=e.reduce((e,t)=>e+t.count,0),r=new ni(.15,.8,4);r.rotateX(Math.PI/2);let i=new _i({color:16777215,roughness:.4}),a=new Vr(r,i,n);a.frustumCulled=!1;let o=new Vr(new oi(1.2,8,8),new _r({visible:!1}),n);o.frustumCulled=!1;let s=new Float32Array(n*3),c=new X,l=new tn,u=[],d=e.map(()=>({pos:new K((Math.random()-.5)*20,Math.random()*3+1,(Math.random()-.5)*100)})),f=0;e.forEach((e,t)=>{for(let n=0;n<e.count;n++){c.setHex(e.color).toArray(s,f*3);let n=d[t].pos,r=new K((Math.random()-.5)*10,(Math.random()-.5)*2,(Math.random()-.5)*10);l.position.copy(n).add(r),l.scale.setScalar(e.scale),l.updateMatrix(),a.setMatrixAt(f,l.matrix),u.push({baseSpeed:(Math.random()*.04+.03)*e.speedMultiplier,turnSpeed:(Math.random()-.5)*.02,preferredHeight:e.preferredHeight+r.y,originalColor:new X(e.color),schoolOffset:r,schoolId:t,scale:1,baseScale:e.scale}),f++}}),a.instanceColor=new Nr(s,3),a.instanceColor.needsUpdate=!0;let p=new nn,m=new oi(1,8,8),h=new _i({color:12759680,roughness:1}),g=[];for(let e=0;e<400;e++){let e=(Math.random()-.5)*100,t=(Math.random()-.5)*180,n=Math.sin(t*.08)*6;if(Math.abs(e+n)>45)continue;let r=Math.sin(e*.05)*2+Math.cos(t*.05)*2-5,i=(Math.abs(e+n)/10)**4,a=r+Math.min(i,12),o=m.clone(),s=new K(e,a-.5,t),c=new Rt(0,Math.random()*Math.PI,0),l=new K(Math.random()*4+2,Math.random()*.6+.2,Math.random()*4+2),u=new Y().compose(s,new st().setFromEuler(c),l);o.applyMatrix4(u),g.push(o)}if(g.length>0){let e=cl(g);p.add(new kr(e,h))}let _=new kr(new oi(100,32,32,0,Math.PI*2,0,Math.PI/2),new _r({color:517,side:1,fog:!1}));_.position.y=-5,p.add(_);let v=new kr(new ai(200,200),new _i({color:35037,transparent:!0,opacity:.6,side:2,roughness:.1,metalness:.8}));v.rotation.x=Math.PI/2,v.position.y=16,p.add(v);let y=new nn,b=new _i({color:3820364,roughness:1,flatShading:!0}),x=[],S=[];for(let e=0;e<1e3;e++){let t=e>400,n=t?Math.random()*.4+.1:Math.random()*6+2,r=(Math.random()-.5)*80,i=(Math.random()-.5)*150;if(!t&&Math.abs(r)<5&&n>3)continue;let a=new ii(n,+!t),o=Math.sin(i*.08)*6,s=Math.sin(r*.05)*2+Math.cos(i*.05)*2-5,c=(Math.abs(r+o)/10)**4,l=new K(r,s+Math.min(c,12)-n*.2,i),u=new Rt(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),d=t?new K(1,1,1):new K(1,1.8+Math.random()*1.5,1),f=new Y().compose(l,new st().setFromEuler(u),d);a.applyMatrix4(f),t||x.push({center:l,radius:n*.85}),S.push(a)}if(S.length>0){let e=cl(S);y.add(new kr(e,b))}let C=new nn,w=new _i({color:16739201,flatShading:!0});t.forEach(e=>{let t=new X(e.color),n=[];for(let t=0;t<e.count;t++){let e,t,r;if(Math.random()>.4&&x.length>0){let n=x[Math.floor(Math.random()*x.length)];e=n.center.x+(Math.random()-.5)*n.radius,r=n.center.z+(Math.random()-.5)*n.radius,t=n.center.y+n.radius*.4}else{e=(Math.random()-.5)*80,r=(Math.random()-.5)*150;let n=Math.sin(r*.08)*6;if(Math.abs(e+n)>40)continue;let i=Math.sin(e*.05)*2+Math.cos(r*.05)*2-5,a=(Math.abs(e+n)/10)**4;t=i+Math.min(a,12)+.2}let i=Math.floor(Math.random()*15)+15;for(let a=0;a<i;a++){let i=Math.random()>.3?new ti(.1,.7,Math.random()*5+1.5,12):new oi(.8,16,16),a=new K(e+(Math.random()-.5)*3.5,t+Math.random()*1.5,r+(Math.random()-.5)*3.5),o=new Rt(Math.random()*1.5,Math.random()*Math.PI,Math.random()*1.5),s=new Y().compose(a,new st().setFromEuler(o),new K(1,1,1));i.applyMatrix4(s),n.push(i)}}if(n.length>0){let r=new kr(cl(n),w.clone());r.material.color.copy(t),r.userData={type:`coral`,id:e.id,name:e.name,desc:e.desc,bleach_year:e.bleach_year,originalColor:t.clone()},C.add(r)}});let T=new nn,E=[2972199,4024887,1919511,5077575,5933642,3033646],D=[],O=E.map(()=>[]);for(let e=0;e<4e3;e++){let e=(Math.random()-.5)*110,t=(Math.random()-.5)*200,n=Math.sin(t*.08)*6,r=Math.sin(e*.05)*2+Math.cos(t*.05)*2-5,i=(Math.abs(e+n)/10)**4,a=r+Math.min(i,12)+.1,o=Math.random()*6+3,s=new ai(.3,o,1,8),c=s.attributes.position,l=new Float32Array(c.count);for(let e=0;e<c.count;e++)l[e]=c.getY(e)+o/2;s.setAttribute(`heightFromBase`,new Gn(l,1));let u=new K(e,a+o/2,t),d=new Rt(0,Math.random()*Math.PI,0),f=new Y().compose(u,new st().setFromEuler(d),new K(1,1,1));s.applyMatrix4(f),O[Math.floor(Math.random()*E.length)].push(s)}let k={uniforms:{time:{value:0},color:{value:new X}},vertexShader:`
            uniform float time;
        ...
        `};E.forEach((e,t)=>{if(O[t].length>0){let n=cl(O[t]),r=new hi({uniforms:fi.clone(k.uniforms),vertexShader:k.vertexShader,fragmentShader:k.fragmentShader,side:2});r.uniforms.color.value.setHex(e),D.push(r),T.add(new kr(n,r))}});let A=new nn,ee=new _r({color:15663103,transparent:!0,opacity:.03,side:2,blending:2,depthWrite:!1});for(let e=0;e<20;e++){let e=new kr(new ti(5,80+Math.random()*40,400,12,1,!0),ee),t=Math.random()*Math.PI*2,n=Math.random()*80;e.position.set(Math.cos(t)*n,150,Math.sin(t)*n),e.rotation.x=(Math.random()-.5)*.3,e.rotation.z=(Math.random()-.5)*.3,A.add(e)}return{fishMesh:a,fishHitboxMesh:o,coralsGroup:C,geographyGroup:y,environmentGroup:p,fishData:u,rockSpheres:x,fishMaterial:i,coralMaterial:w,rockMaterial:b,seaweedsGroup:T,seaweedMaterials:D,sunRaysGroup:A,sunRayMaterial:ee}}var dl=Object.freeze({Linear:Object.freeze({None:function(e){return e},In:function(e){return e},Out:function(e){return e},InOut:function(e){return e}}),Quadratic:Object.freeze({In:function(e){return e*e},Out:function(e){return e*(2-e)},InOut:function(e){return(e*=2)<1?.5*e*e:-.5*(--e*(e-2)-1)}}),Cubic:Object.freeze({In:function(e){return e*e*e},Out:function(e){return--e*e*e+1},InOut:function(e){return(e*=2)<1?.5*e*e*e:.5*((e-=2)*e*e+2)}}),Quartic:Object.freeze({In:function(e){return e*e*e*e},Out:function(e){return 1- --e*e*e*e},InOut:function(e){return(e*=2)<1?.5*e*e*e*e:-.5*((e-=2)*e*e*e-2)}}),Quintic:Object.freeze({In:function(e){return e*e*e*e*e},Out:function(e){return--e*e*e*e*e+1},InOut:function(e){return(e*=2)<1?.5*e*e*e*e*e:.5*((e-=2)*e*e*e*e+2)}}),Sinusoidal:Object.freeze({In:function(e){return 1-Math.sin((1-e)*Math.PI/2)},Out:function(e){return Math.sin(e*Math.PI/2)},InOut:function(e){return .5*(1-Math.sin(Math.PI*(.5-e)))}}),Exponential:Object.freeze({In:function(e){return e===0?0:1024**(e-1)},Out:function(e){return e===1?1:1-2**(-10*e)},InOut:function(e){return e===0?0:e===1?1:(e*=2)<1?.5*1024**(e-1):.5*(-(2**(-10*(e-1)))+2)}}),Circular:Object.freeze({In:function(e){return 1-Math.sqrt(1-e*e)},Out:function(e){return Math.sqrt(1- --e*e)},InOut:function(e){return(e*=2)<1?-.5*(Math.sqrt(1-e*e)-1):.5*(Math.sqrt(1-(e-=2)*e)+1)}}),Elastic:Object.freeze({In:function(e){return e===0?0:e===1?1:-(2**(10*(e-1)))*Math.sin((e-1.1)*5*Math.PI)},Out:function(e){return e===0?0:e===1?1:2**(-10*e)*Math.sin((e-.1)*5*Math.PI)+1},InOut:function(e){return e===0?0:e===1?1:(e*=2,e<1?-.5*2**(10*(e-1))*Math.sin((e-1.1)*5*Math.PI):.5*2**(-10*(e-1))*Math.sin((e-1.1)*5*Math.PI)+1)}}),Back:Object.freeze({In:function(e){var t=1.70158;return e===1?1:e*e*((t+1)*e-t)},Out:function(e){var t=1.70158;return e===0?0:--e*e*((t+1)*e+t)+1},InOut:function(e){var t=1.70158*1.525;return(e*=2)<1?.5*(e*e*((t+1)*e-t)):.5*((e-=2)*e*((t+1)*e+t)+2)}}),Bounce:Object.freeze({In:function(e){return 1-dl.Bounce.Out(1-e)},Out:function(e){return e<1/2.75?7.5625*e*e:e<2/2.75?7.5625*(e-=1.5/2.75)*e+.75:e<2.5/2.75?7.5625*(e-=2.25/2.75)*e+.9375:7.5625*(e-=2.625/2.75)*e+.984375},InOut:function(e){return e<.5?dl.Bounce.In(e*2)*.5:dl.Bounce.Out(e*2-1)*.5+.5}}),generatePow:function(e){return e===void 0&&(e=4),e=e<2**-52?2**-52:e,e=e>1e4?1e4:e,{In:function(t){return t**+e},Out:function(t){return 1-(1-t)**e},InOut:function(t){return t<.5?(t*2)**e/2:(1-(2-t*2)**e)/2+.5}}}}),fl=function(){return performance.now()},pl=function(){function e(){var e=[...arguments];this._tweens={},this._tweensAddedDuringUpdate={},this.add.apply(this,e)}return e.prototype.getAll=function(){var e=this;return Object.keys(this._tweens).map(function(t){return e._tweens[t]})},e.prototype.removeAll=function(){this._tweens={}},e.prototype.add=function(){for(var e,t=[],n=0;n<arguments.length;n++)t[n]=arguments[n];for(var r=0,i=t;r<i.length;r++){var a=i[r];(e=a._group)==null||e.remove(a),a._group=this,this._tweens[a.getId()]=a,this._tweensAddedDuringUpdate[a.getId()]=a}},e.prototype.remove=function(){for(var e=[...arguments],t=0,n=e;t<n.length;t++){var r=n[t];r._group=void 0,delete this._tweens[r.getId()],delete this._tweensAddedDuringUpdate[r.getId()]}},e.prototype.allStopped=function(){return this.getAll().every(function(e){return!e.isPlaying()})},e.prototype.update=function(e,t){e===void 0&&(e=fl()),t===void 0&&(t=!0);var n=Object.keys(this._tweens);if(n.length!==0)for(;n.length>0;){this._tweensAddedDuringUpdate={};for(var r=0;r<n.length;r++){var i=this._tweens[n[r]],a=!t;i&&i.update(e,a)===!1&&!t&&this.remove(i)}n=Object.keys(this._tweensAddedDuringUpdate)}},e}(),ml={Linear:function(e,t){var n=e.length-1,r=n*t,i=Math.floor(r),a=ml.Utils.Linear;return t<0?a(e[0],e[1],r):t>1?a(e[n],e[n-1],n-r):a(e[i],e[i+1>n?n:i+1],r-i)},Bezier:function(e,t){for(var n=0,r=e.length-1,i=Math.pow,a=ml.Utils.Bernstein,o=0;o<=r;o++)n+=i(1-t,r-o)*i(t,o)*e[o]*a(r,o);return n},CatmullRom:function(e,t){var n=e.length-1,r=n*t,i=Math.floor(r),a=ml.Utils.CatmullRom;return e[0]===e[n]?(t<0&&(i=Math.floor(r=n*(1+t))),a(e[(i-1+n)%n],e[i],e[(i+1)%n],e[(i+2)%n],r-i)):t<0?e[0]-(a(e[0],e[0],e[1],e[1],-r)-e[0]):t>1?e[n]-(a(e[n],e[n],e[n-1],e[n-1],r-n)-e[n]):a(e[i?i-1:0],e[i],e[n<i+1?n:i+1],e[n<i+2?n:i+2],r-i)},Utils:{Linear:function(e,t,n){return(t-e)*n+e},Bernstein:function(e,t){var n=ml.Utils.Factorial;return n(e)/n(t)/n(e-t)},Factorial:(function(){var e=[1];return function(t){var n=1;if(e[t])return e[t];for(var r=t;r>1;r--)n*=r;return e[t]=n,n}})(),CatmullRom:function(e,t,n,r,i){var a=(n-e)*.5,o=(r-t)*.5,s=i*i,c=i*s;return(2*t-2*n+a+o)*c+(-3*t+3*n-2*a-o)*s+a*i+t}}},hl=function(){function e(){}return e.nextId=function(){return e._nextId++},e._nextId=0,e}(),gl=new pl;(function(){function e(e,t){this._isPaused=!1,this._pauseStart=0,this._valuesStart={},this._valuesEnd={},this._valuesStartRepeat={},this._duration=1e3,this._isDynamic=!1,this._initialRepeat=0,this._repeat=0,this._yoyo=!1,this._isPlaying=!1,this._reversed=!1,this._delayTime=0,this._startTime=0,this._easingFunction=dl.Linear.None,this._interpolationFunction=ml.Linear,this._chainedTweens=[],this._onStartCallbackFired=!1,this._onEveryStartCallbackFired=!1,this._id=hl.nextId(),this._isChainStopped=!1,this._propertiesAreSetUp=!1,this._goToEnd=!1,this._object=e,typeof t==`object`?(this._group=t,t.add(this)):t===!0&&(this._group=gl,gl.add(this))}return e.prototype.getId=function(){return this._id},e.prototype.isPlaying=function(){return this._isPlaying},e.prototype.isPaused=function(){return this._isPaused},e.prototype.getDuration=function(){return this._duration},e.prototype.to=function(e,t){if(t===void 0&&(t=1e3),this._isPlaying)throw Error(`Can not call Tween.to() while Tween is already started or paused. Stop the Tween first.`);return this._valuesEnd=e,this._propertiesAreSetUp=!1,this._duration=t<0?0:t,this},e.prototype.duration=function(e){return e===void 0&&(e=1e3),this._duration=e<0?0:e,this},e.prototype.dynamic=function(e){return e===void 0&&(e=!1),this._isDynamic=e,this},e.prototype.start=function(e,t){if(e===void 0&&(e=fl()),t===void 0&&(t=!1),this._isPlaying)return this;if(this._repeat=this._initialRepeat,this._reversed)for(var n in this._reversed=!1,this._valuesStartRepeat)this._swapEndStartRepeatValues(n),this._valuesStart[n]=this._valuesStartRepeat[n];if(this._isPlaying=!0,this._isPaused=!1,this._onStartCallbackFired=!1,this._onEveryStartCallbackFired=!1,this._isChainStopped=!1,this._startTime=e,this._startTime+=this._delayTime,!this._propertiesAreSetUp||t){if(this._propertiesAreSetUp=!0,!this._isDynamic){var r={};for(var i in this._valuesEnd)r[i]=this._valuesEnd[i];this._valuesEnd=r}this._setupProperties(this._object,this._valuesStart,this._valuesEnd,this._valuesStartRepeat,t)}return this},e.prototype.startFromCurrentValues=function(e){return this.start(e,!0)},e.prototype._setupProperties=function(e,t,n,r,i){for(var a in n){var o=e[a],s=Array.isArray(o),c=s?`array`:typeof o,l=!s&&Array.isArray(n[a]);if(!(c===`undefined`||c===`function`)){if(l){var u=n[a];if(u.length===0)continue;for(var d=[o],f=0,p=u.length;f<p;f+=1){var m=this._handleRelativeValue(o,u[f]);if(isNaN(m)){l=!1,console.warn(`Found invalid interpolation list. Skipping.`);break}d.push(m)}l&&(n[a]=d)}if((c===`object`||s)&&o&&!l){t[a]=s?[]:{};var h=o;for(var g in h)t[a][g]=h[g];r[a]=s?[]:{};var u=n[a];if(!this._isDynamic){var _={};for(var g in u)_[g]=u[g];n[a]=u=_}this._setupProperties(h,t[a],u,r[a],i)}else (t[a]===void 0||i)&&(t[a]=o),s||(t[a]*=1),l?r[a]=n[a].slice().reverse():r[a]=t[a]||0}}},e.prototype.stop=function(){return this._isChainStopped||(this._isChainStopped=!0,this.stopChainedTweens()),this._isPlaying?(this._isPlaying=!1,this._isPaused=!1,this._onStopCallback&&this._onStopCallback(this._object),this):this},e.prototype.end=function(){return this._goToEnd=!0,this.update(this._startTime+this._duration),this},e.prototype.pause=function(e){return e===void 0&&(e=fl()),this._isPaused||!this._isPlaying?this:(this._isPaused=!0,this._pauseStart=e,this)},e.prototype.resume=function(e){return e===void 0&&(e=fl()),!this._isPaused||!this._isPlaying?this:(this._isPaused=!1,this._startTime+=e-this._pauseStart,this._pauseStart=0,this)},e.prototype.stopChainedTweens=function(){for(var e=0,t=this._chainedTweens.length;e<t;e++)this._chainedTweens[e].stop();return this},e.prototype.group=function(e){return e?(e.add(this),this):(console.warn(`tween.group() without args has been removed, use group.add(tween) instead.`),this)},e.prototype.remove=function(){var e;return(e=this._group)==null||e.remove(this),this},e.prototype.delay=function(e){return e===void 0&&(e=0),this._delayTime=e,this},e.prototype.repeat=function(e){return e===void 0&&(e=0),this._initialRepeat=e,this._repeat=e,this},e.prototype.repeatDelay=function(e){return this._repeatDelayTime=e,this},e.prototype.yoyo=function(e){return e===void 0&&(e=!1),this._yoyo=e,this},e.prototype.easing=function(e){return e===void 0&&(e=dl.Linear.None),this._easingFunction=e,this},e.prototype.interpolation=function(e){return e===void 0&&(e=ml.Linear),this._interpolationFunction=e,this},e.prototype.chain=function(){return this._chainedTweens=[...arguments],this},e.prototype.onStart=function(e){return this._onStartCallback=e,this},e.prototype.onEveryStart=function(e){return this._onEveryStartCallback=e,this},e.prototype.onUpdate=function(e){return this._onUpdateCallback=e,this},e.prototype.onRepeat=function(e){return this._onRepeatCallback=e,this},e.prototype.onComplete=function(e){return this._onCompleteCallback=e,this},e.prototype.onStop=function(e){return this._onStopCallback=e,this},e.prototype.update=function(t,n){var r=this;if(t===void 0&&(t=fl()),n===void 0&&(n=e.autoStartOnUpdate),this._isPaused)return!0;var i;if(!this._goToEnd&&!this._isPlaying)if(n)this.start(t,!0);else return!1;if(this._goToEnd=!1,t<this._startTime)return!0;this._onStartCallbackFired===!1&&(this._onStartCallback&&this._onStartCallback(this._object),this._onStartCallbackFired=!0),this._onEveryStartCallbackFired===!1&&(this._onEveryStartCallback&&this._onEveryStartCallback(this._object),this._onEveryStartCallbackFired=!0);var a=t-this._startTime,o=this._duration+(this._repeatDelayTime??this._delayTime),s=this._duration+this._repeat*o,c=function(){if(r._duration===0||a>s)return 1;var e=a-Math.trunc(a/o)*o,t=Math.min(e/r._duration,1);return t===0&&a===r._duration?1:t}(),l=this._easingFunction(c);if(this._updateProperties(this._object,this._valuesStart,this._valuesEnd,l),this._onUpdateCallback&&this._onUpdateCallback(this._object,c),this._duration===0||a>=this._duration)if(this._repeat>0){var u=Math.min(Math.trunc((a-this._duration)/o)+1,this._repeat);for(i in isFinite(this._repeat)&&(this._repeat-=u),this._valuesStartRepeat)!this._yoyo&&typeof this._valuesEnd[i]==`string`&&(this._valuesStartRepeat[i]=this._valuesStartRepeat[i]+parseFloat(this._valuesEnd[i])),this._yoyo&&this._swapEndStartRepeatValues(i),this._valuesStart[i]=this._valuesStartRepeat[i];return this._yoyo&&(this._reversed=!this._reversed),this._startTime+=o*u,this._onRepeatCallback&&this._onRepeatCallback(this._object),this._onEveryStartCallbackFired=!1,!0}else{this._onCompleteCallback&&this._onCompleteCallback(this._object);for(var d=0,f=this._chainedTweens.length;d<f;d++)this._chainedTweens[d].start(this._startTime+this._duration,!1);return this._isPlaying=!1,!1}return!0},e.prototype._updateProperties=function(e,t,n,r){for(var i in n)if(t[i]!==void 0){var a=t[i]||0,o=n[i];!Array.isArray(e[i])&&Array.isArray(o)?e[i]=this._interpolationFunction(o,r):typeof o==`object`&&o?this._updateProperties(e[i],a,o,r):(o=this._handleRelativeValue(a,o),typeof o==`number`&&(e[i]=a+(o-a)*r))}},e.prototype._handleRelativeValue=function(e,t){return typeof t==`string`?t.charAt(0)===`+`||t.charAt(0)===`-`?e+parseFloat(t):parseFloat(t):t},e.prototype._swapEndStartRepeatValues=function(e){var t=this._valuesStartRepeat[e],n=this._valuesEnd[e];typeof n==`string`?this._valuesStartRepeat[e]=this._valuesStartRepeat[e]+parseFloat(n):this._valuesStartRepeat[e]=this._valuesEnd[e],this._valuesEnd[e]=t},e.autoStartOnUpdate=!1,e})(),hl.nextId;var _l=gl;_l.getAll.bind(_l),_l.removeAll.bind(_l),_l.add.bind(_l),_l.remove.bind(_l);var vl=_l.update.bind(_l),yl=new fn,bl=new X(35037),xl=new X(43690);yl.background=new X(0),yl.fog=new dn(bl,.012);var Sl=new Ji(70,window.innerWidth/window.innerHeight,.1,500);Sl.position.set(0,5,10);var Cl=new Bc({antialias:!0});Cl.setSize(window.innerWidth,window.innerHeight),Cl.setPixelRatio(window.devicePixelRatio),document.body.appendChild(Cl.domElement);var wl=new ol(Cl);wl.addPass(new sl(yl,Sl));var Tl=new rl({uniforms:{tDiffuse:{value:null},strength:{value:.15},center:{value:new G(.5,.5)}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
    ...
    `});wl.addPass(Tl);var El=new Qi(1718878,.1);yl.add(El);var Dl=new Xi(16777215,50,80,Math.PI/6,.1,2);Dl.position.set(0,0,0),Sl.add(Dl);var Ol=new tn;Ol.position.set(0,0,-10),Sl.add(Ol),Dl.target=Ol;var kl=new ni(6,60,32,1,!0);kl.translate(0,-30,0),kl.rotateX(-Math.PI/2);var Al=new hi({transparent:!0,depthWrite:!1,blending:2,uniforms:{color:{value:new X(16777215)},opacity:{value:.3}},vertexShader:`varying vec2 vUv; varying float vDepth; void main() { vUv = uv; vec4 mvPosition = modelViewMatrix * vec4(position, 1.0); vDepth = -mvPosition.z; gl_Position = projectionMatrix * mvPosition; }`,fragmentShader:`varying vec2 vUv; varying float vDepth; uniform vec3 color; uniform float opacity; void main() { float radial = 1.0 - smoothstep(0.0, 0.5, length(vUv - 0.5)); float distFade = 1.0 - smoothstep(0.0, 50.0, vDepth); gl_FragColor = vec4(color, radial * distFade * opacity); }`}),jl=new kr(kl,Al);Sl.add(jl),yl.add(Sl);var Ml=new Jc(Sl,document.body),Nl=document.getElementById(`instructions`),Pl=document.getElementById(`year-slider`),Fl=document.getElementById(`year-value`),Il=document.getElementById(`brightness-slider`),Ll=document.getElementById(`fish-popup`),Rl=document.getElementById(`fish-name`),zl=document.getElementById(`fish-desc`),Bl=document.getElementById(`popup-close`),Vl=document.getElementById(`bingo-book`),Hl=document.getElementById(`bingo-grid`),Ul=document.getElementById(`bingo-overlay`),Wl=document.getElementById(`pause-indicator`),Gl=!1,Kl=!0,ql=!0,Jl=!1,Yl=performance.now(),Xl=0,Zl=300,Ql={forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1},$l=new K,eu=new K,tu=[],nu=[],ru=new Set(JSON.parse(localStorage.getItem(`discoveredSpecies`)||`[]`)),iu=[],au=0,ou={},$,su=1200,cu=new Y,lu=new K,uu=new st,du=new K(1,1,1),fu=new tn,pu=new va,mu=new G;function hu(e){Il.value=e.toFixed(1),Dl.intensity=e*100,Al.uniforms.opacity.value=e/3*.4}function gu(){Ll.style.display=`none`,Gl=!1,Wl.style.display=`none`,Ml.lock()}function _u(e,t,n){Xl=performance.now(),Rl.innerText=t,zl.innerText=n,Ll.style.display=`block`,Gl=!0,Wl.style.display=`flex`,Jl=!0,Ml.unlock(),ru.has(e)||(ru.add(e),localStorage.setItem(`discoveredSpecies`,JSON.stringify(Array.from(ru))))}function vu(){performance.now()-Xl<Zl||(Xl=performance.now(),Vl.style.display===`block`?(Vl.style.display=`none`,Ul.style.display=`none`,Gl=!1,Wl.style.display=`none`,Ml.lock()):(yu(),Vl.style.display=`block`,Ul.style.display=`block`,Gl=!0,Wl.style.display=`flex`,Jl=!0,Ml.unlock()))}function yu(){Hl.innerHTML=``,[{title:`Vertebrate Marine Life`,species:iu.map(e=>({id:e.id,name:e.name||e.id}))},{title:`Coral Reef Structures`,species:nu.map(e=>({id:e.id,name:e.name||e.id}))}].forEach(e=>{let t=document.createElement(`div`);t.className=`bingo-category-header`,t.innerText=e.title,Hl.appendChild(t),e.species.forEach(e=>{let t=ru.has(e.id),n=document.createElement(`div`);n.className=`bingo-slot ${t?`discovered`:``}`;let r=document.createElement(`div`);r.className=`bingo-icon`,r.innerText=t?`✓`:`?`;let i=document.createElement(`div`);i.className=`bingo-label`,i.innerText=e.name,n.appendChild(r),n.appendChild(i),Hl.appendChild(n)})})}var bu=new X(4478310),xu=new X;function Su(e){if($&&$.fishMesh&&$.fishMesh.instanceColor){for(let t=0;t<au;t++)xu.copy(bu).lerp($.fishData[t].originalColor,e),$.fishMesh.setColorAt(t,xu);$.fishMesh.instanceColor.needsUpdate=!0}}function Cu(e){let t=tu.find(t=>t.year===e);t&&Object.keys(t.counts).forEach(e=>{let n=t.counts[e],r=ou[e],i=iu.find(t=>t.id===e),a=i?i.count:0;for(let e=0;e<a;e++)$.fishData[r+e]&&($.fishData[r+e].scale=+(e<n))})}function wu(e,t){let n=Math.max(0,Math.min(1,(e-7.6)/.5));document.getElementById(`stat-ph`).innerText=e.toFixed(2),document.getElementById(`stat-temp`).innerText=t.toFixed(1)+` °C`,document.getElementById(`stat-vit`).innerText=(n*100).toFixed(0)+`%`,Su(n)}function Tu(e){Pl.value=e.toString(),Fl.innerText=e.toString();let t=e-2014;wu(8.1-t*.04,10+t*.15),Cu(e);let n=new X(13421772);$&&$.coralsGroup&&$.coralsGroup.children.forEach(t=>{let r=t.userData;if(r.type===`coral`){let i=e>=r.bleach_year?n:r.originalColor;t.material.color.copy(i)}})}Nl.addEventListener(`click`,()=>Ml.lock()),Ml.addEventListener(`lock`,()=>{Nl.style.opacity=`0`,Nl.style.pointerEvents=`none`}),Ml.addEventListener(`unlock`,()=>{if(Jl){Jl=!1;return}if(Ll.style.display===`block`){Ll.style.display=`none`,Gl=!1,Wl.style.display=`none`;return}if(Vl.style.display===`block`){Vl.style.display=`none`,Ul.style.display=`none`,Gl=!1,Wl.style.display=`none`;return}Nl.style.opacity=`1`,Nl.style.pointerEvents=`auto`}),document.body.addEventListener(`click`,()=>{Ll.style.display===`block`||Vl.style.display===`block`||!Ml.isLocked&&Nl.style.opacity===`0`&&Ml.lock()}),document.addEventListener(`keydown`,e=>{if(e.code===`Tab`){e.preventDefault(),vu();return}switch(e.code){case`KeyM`:Ml.isLocked&&Ml.unlock();break;case`KeyW`:Ql.forward=!0;break;case`KeyA`:Ql.left=!0;break;case`KeyS`:Ql.backward=!0;break;case`KeyD`:Ql.right=!0;break;case`Space`:Ql.up=!0;break;case`ShiftLeft`:case`ShiftRight`:Ql.down=!0;break;case`KeyF`:Kl=!Kl,Dl.visible=Kl,jl.visible=Kl;break;case`KeyB`:ql=!ql,Tl.enabled=ql;break;case`KeyP`:Gl=!Gl,Wl.style.display=Gl?`flex`:`none`;break}let t=parseInt(Pl.value);e.key===`[`&&t>2014&&Tu(t-1),e.key===`]`&&t<2026&&Tu(t+1)}),document.addEventListener(`keyup`,e=>{switch(e.code){case`KeyW`:Ql.forward=!1;break;case`KeyA`:Ql.left=!1;break;case`KeyS`:Ql.backward=!1;break;case`KeyD`:Ql.right=!1;break;case`Space`:Ql.up=!1;break;case`ShiftLeft`:case`ShiftRight`:Ql.down=!1;break}}),Il.addEventListener(`input`,e=>hu(parseFloat(e.target.value))),Il.addEventListener(`click`,e=>e.stopPropagation()),Pl.addEventListener(`click`,e=>e.stopPropagation()),Pl.addEventListener(`input`,e=>Tu(parseInt(e.target.value))),Bl.addEventListener(`click`,e=>{e.stopPropagation(),gu()}),Ll.addEventListener(`click`,e=>e.stopPropagation()),Ul.addEventListener(`click`,()=>vu()),window.addEventListener(`mousemove`,e=>{Ml.isLocked?(mu.x=0,mu.y=0):(mu.x=e.clientX/window.innerWidth*2-1,mu.y=-(e.clientY/window.innerHeight)*2+1)}),window.addEventListener(`pointerdown`,e=>{if(e.button!==0||Vl.style.display===`block`||Ll.style.display===`block`||!Ml.isLocked&&!Gl)return;pu.setFromCamera(mu,Sl);let t=pu.intersectObject($.fishHitboxMesh),n=pu.intersectObjects($.coralsGroup.children,!0),r=-1,i=``;if(t.length>0)r=t[0].instanceId,i=iu[$.fishData[r].schoolId%iu.length].id;else if(n.length>0){let e=n[0].object;for(;e.parent&&e.userData.type!==`coral`;)e=e.parent;let t=e.userData;if(t.type===`coral`){_u(t.id,t.name.toUpperCase(),t.desc);return}}else{let e=1/0,t=new K,n=new Y;for(let i=0;i<au;i++){let a=$.fishData[i];if(!a||a.scale<=0)continue;$.fishMesh.getMatrixAt(i,n),t.setFromMatrixPosition(n);let o=pu.ray.distanceToPoint(t);o<2.5&&o<e&&(e=o,r=i)}r!==-1&&(i=iu[$.fishData[r].schoolId%iu.length].id)}if(r!==-1){let e=iu.find(e=>e.id===i);e&&_u(e.id,i.toUpperCase(),e.desc||`Scan complete.`)}}),window.addEventListener(`resize`,()=>{Sl.aspect=window.innerWidth/window.innerHeight,Sl.updateProjectionMatrix(),Cl.setSize(window.innerWidth,window.innerHeight),wl.setSize(window.innerWidth,window.innerHeight)});function Eu(){requestAnimationFrame(Eu);let e=performance.now(),t=(e-Yl)/1e3;Yl=e;let n=Sl.position.y,r=Math.max(0,Math.min(1,(35-n)/40)),i=bl.clone().lerp(xl,r);if(yl.fog instanceof dn&&(yl.fog.color.copy(i),yl.fog.density=.05-(1-r)*.04),El.intensity=.1+r*.2,Ml.isLocked===!0){let e=Sl.position.clone();$l.x-=$l.x*5*t,$l.z-=$l.z*5*t,$l.y-=$l.y*5*t,eu.z=Number(Ql.forward)-Number(Ql.backward),eu.x=Number(Ql.right)-Number(Ql.left),eu.y=Number(Ql.up)-Number(Ql.down),eu.normalize(),(Ql.forward||Ql.backward)&&($l.z-=eu.z*30*t),(Ql.left||Ql.right)&&($l.x-=eu.x*30*t),(Ql.up||Ql.down)&&($l.y+=eu.y*30*t),Ml.moveRight(-$l.x*t),Ml.moveForward(-$l.z*t),Ml.object.position.y+=$l.y*t;let n=Ml.object.position;for(let t of $.rockSpheres)if(n.distanceTo(t.center)<t.radius+1.5){n.copy(e),$l.set(0,0,0);break}let r=Math.sin(n.z*.08)*6,i=Math.sin(n.x*.05)*2+Math.cos(n.z*.05)*2-5,a=(Math.abs(n.x+r)/10)**4,o=i+Math.min(a,12);n.y<o+2&&(n.y=o+2,$l.y=0),n.y>15&&(n.y=15,$l.y=0),Math.abs(n.x)>40&&(n.x=Math.sign(n.x)*40),Math.abs(n.z)>70&&(n.z=Math.sign(n.z)*70)}if($.sunRayMaterial.opacity=Math.max(0,.04*(1-r)),$.seaweedMaterials&&$.seaweedMaterials.forEach(t=>t.uniforms.time.value=e*.001),!Gl){vl();let t=[new K(Math.sin(e*2e-4)*15,2.5,Math.cos(e*1e-4)*80),new K(Math.cos(e*15e-5)*10,4,Math.sin(e*8e-5)*70),new K(Math.sin(e*25e-5)*20,3.5,Math.cos(e*15e-5)*90),new K(Math.cos(e*22e-5)*12,1.5,Math.sin(e*12e-5)*85)],n=Sl.position;for(let r=0;r<au;r++){$.fishMesh.getMatrixAt(r,cu),cu.decompose(lu,uu,du);let i=$.fishData[r],a=t[i.schoolId%t.length];if(!a)continue;let o=a.clone().add(i.schoolOffset);if(lu.distanceTo(n)>70){let e=Math.random()*Math.PI*2,t=30+Math.random()*20;lu.set(n.x+Math.cos(e)*t,i.preferredHeight,n.z+Math.sin(e)*t),cu.setPosition(lu),$.fishMesh.setMatrixAt(r,cu)}let s=lu.clone();if(lu.lerp(o,.005),lu.distanceTo(s)>1e-4){fu.position.copy(lu),fu.lookAt(o),fu.rotateY(Math.sin(e*.001+r)*.2);let t=i.baseScale*i.scale;fu.scale.set(t,t,t),fu.updateMatrix(),$.fishMesh.setMatrixAt(r,fu.matrix),$.fishHitboxMesh.setMatrixAt(r,fu.matrix)}}$.fishMesh.instanceMatrix.needsUpdate=!0,$.fishHitboxMesh.instanceMatrix.needsUpdate=!0}wl.render()}async function Du(){let[e,t,n]=await Promise.all([fetch(`/data/populations.json`).then(e=>e.json()),fetch(`/data/coral_registry.json`).then(e=>e.json()),fetch(`/data/fish_metadata.json`).then(e=>e.json())]);tu=e,nu=t,iu=n.map(e=>({...e,color:parseInt(e.color.replace(`#`,`0x`))})),au=iu.reduce((e,t)=>e+t.count,0);let r=0;iu.forEach(e=>{ou[e.id]=r,r+=e.count});let i=t.map(e=>({...e,count:Math.floor(e.proportion*su)}));$=ul(iu,i),yl.add($.fishMesh),yl.add($.fishHitboxMesh),yl.add($.coralsGroup),yl.add($.sunRaysGroup),yl.add($.geographyGroup),yl.add($.environmentGroup),yl.add($.seaweedsGroup),Tu(2014),Eu()}Du();